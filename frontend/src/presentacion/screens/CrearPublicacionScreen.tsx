    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity
          ...
          disabled={cargando}
          style={[styles.shareBtn, cargando && { opacity: 0.5 }]}
        >
          {cargando
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        {imagenes.length > 0 && (
          <View style={styles.imageGrid}>
            ...
            {imagenes.length < 10 && (
              <TouchableOpacity style={styles.addMoreImg} onPress={seleccionarImagen}>
        ...
        {imagenes.length === 0 && (
          <TouchableOpacity style={styles.addImgBtn} onPress={seleccionarImagen}>
            ...
            <Text style={styles.addImgSub}>Máximo 10 imágenes</Text>
          </TouchableOpacity>
        )}
      </ScrollView>
    </SafeAreaView>
